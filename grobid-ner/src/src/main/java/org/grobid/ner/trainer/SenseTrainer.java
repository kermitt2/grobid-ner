...
public class SenseTrainer extends AbstractTrainer {
	...
	private static int LIMIT = 1; // limit of files to process per zip archives, -1 if no limit
	private static int GLOBAL_LIMIT = 10; // overall limit of files to process, -1 if no limit
        ...
        try {
            for (String line : texts) {
                ...
                FeaturesVectorNERSense featuresVector =
                        FeaturesVectorNERSense.addFeatures(line, isLocationToken, isPersonTitleToken, 
