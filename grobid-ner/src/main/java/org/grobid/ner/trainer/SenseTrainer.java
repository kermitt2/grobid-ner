...
public class SenseTrainer extends AbstractTrainer {
	...
	private static int LIMIT = 50; // limit of files to process per zip archives, -1 if no limit
	private static int GLOBAL_LIMIT = 500; // overall limit of files to process, -1 if no limit
