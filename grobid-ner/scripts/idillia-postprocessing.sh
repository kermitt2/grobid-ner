...
find ./ -type f -name *.xml -exec egrep --color  'PERIOD">[0-9A-Za-z ,-\.]+<\/ENAMEX>[ -]{3}<ENAMEX type="PERIOD"' {} \;
...
find ./ -type f -name *.xml -exec egrep --color  'PERIOD">[0-9A-Za-z ,-\.]+<\/ENAMEX>[ ,]{2}<ENAMEX type="PERIOD"' {} \;
...
find ./ -type f -name *.xml -exec egrep --color  'PERIOD">[0-9A-Za-z ,-\.]+<\/ENAMEX>[ and]{5}<ENAMEX type="PERIOD"' {} \;
